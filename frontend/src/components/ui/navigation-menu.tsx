...
function NavigationMenuContent({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Content>) {
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        'data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out data-[motion=from-end]:slide-in-from-right-52! data-[motion=from-start]:slide-in-from-left-52! data-[motion=to-end]:slide-out-to-right-52! data-[motion=to-start]:slide-out-to-left-52! top-0 left-0 w-full p-2 pr-2.5 md:absolute md:w-auto z-[1200]',
...
function NavigationMenuViewport({
  ...
  return (
    <div className={cn('absolute top-full left-0 isolate z-[1200] flex justify-center')}>
...
const NavigationMenuPositioner = ({ children }: { children?: React.ReactNode }) => <>{children}</>;
const NavigationMenuPopup = ({ children }: { children?: React.ReactNode }) => <>{children}</>;
const NavigationMenuArrow = () => null;
